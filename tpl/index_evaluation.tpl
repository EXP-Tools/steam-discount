<html lang="zh-cn">
 ...
 <body class="html">
  ...
  <div>
   <br />
   <h2><a href="https://github.com/lyy289065406/steam-discount">Steam 游戏测评排名</a> (top %(limit)i)</h2>
   %(datetime)s
   <br />
   <br />

  [<a href="index_discount.html">Steam 特惠折扣排名</a>] [<a href="index_hot.html">Steam 游戏热度排名</a>]
   <br />
   <br />
